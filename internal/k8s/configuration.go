...
func (c *Configuration) FindResourcesForAppProtectDosProtected(protectedNamespace string, protectedName string) []Resource {
	return c.findResourcesForResourceReference(protectedNamespace, protectedName, c.appDosProtectedChecker)
}
