...
1. Build the image:
    * For **NGINX**:
      ...
      As a result, the image **myregistry.example.com/nginx-ingress:2.0.2** is built. Note that the tag `2.0.2` comes from the `VERSION` variable, defined in the Makefile.
